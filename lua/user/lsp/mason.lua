...
mason.setup {
    ui = {
        ...
        keymaps = {
            ...
            uninstall_package = "X", -- Keymap to cancel a package installation
...
-- Get all files in 'settings' directory.
for _, server in pairs(servers) do
    ...
    local server_status_ok, conf_opts = pcall(require, 'user.lsp.settings.' .. server)
